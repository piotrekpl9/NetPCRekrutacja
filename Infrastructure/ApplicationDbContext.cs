...
public class ApplicationDbContext : DbContext, IApplicationDbContext
{
    ...
    { 
        ...
        modelBuilder.Entity<Domain.Entity.Category>().HasData(
            new Domain.Entity.Category(workNumberId, "Business"),
            new Domain.Entity.Category(Guid.Parse("6b2fe5c0-2b92-4fc7-84ab-d5f4885bc907"), "Private"),
            new Domain.Entity.Category(Guid.Parse("0d6c2e2a-0f2e-4f05-af8e-f2fc8ef3ac11"), "Other")
        );
        
        modelBuilder.Entity<Domain.Entity.Subcategory>().HasData(
            new Domain.Entity.Subcategory(Guid.Parse("080de9db-ed11-4d44-ab6e-4931fbcce785"),workNumberId,"Boss", true),
            new Domain.Entity.Subcategory(Guid.Parse("b8fb7cf0-3658-4ddd-8992-5340d7e559b0"),workNumberId, "Client", true)
        );
    }
